        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="container" class="">
                <div>
                    <?php
                        $query = $mysqli->query("SELECT * , e.id_evento, l.id_local, l.nombre_local FROM eventos e, locales l WHERE id_evento = $id");
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="Introduzca la ruta de la fotografia" name="fotoEvento" id="fotoEvento" value="' . $valores[0] . '" required >
                        </div>
    
                        <div class="form-group">
                            <label>Nombre del evento</label>
                            <input type="text" class="form-control" name="nombreEvento" id="nombreEvento" value="' . $valores[1] . '" required maxlength="30" />
                        </div>
    
                        <div class="form-group">
                            <label>Fecha</label>
                            <br>
                            <input type="date" class="form-control"  id="fechaEvento" name="fechaEvento" value="' . $valores[2] . '" required >
                        </div>
    
                        <div class="form-group">
                            <label>Edad del evento</label>
                            <input type="number" class="form-control" name="edadEvento" id="edadEvento" value="' . $valores[3] . '" required maxlength="30" />
                        </div>
    
                        <div class="form-group">
                            <label>Precio</label>
                            <input type="number" class="form-control" name="precioEvento" id="precioEvento" value="' . $valores[4] . '" required maxlength="30" />
                        </div>
    
                        <div class="form-group">
                            <label>Artista</label>
                            <input type="text" class="form-control" name="artistaEvento" id="artistaEvento" value="' . $valores[5] . '" required/>
                        </div>
